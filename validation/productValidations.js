...
const productSchema = Joi.object({
  ...
  category: Joi.string().required().valid("jersey", "shorts", "jacket", "headgear", "other").messages({
    "any.only": "Category must be one of: jersey, shorts, jacket, headgear, other"
  }),
...
const productUpdateSchema = Joi.object({
  ...
  category: Joi.string().optional().valid("jersey", "shorts", "jacket", "headgear", "other"),
...
const productStatusSchema = Joi.object({
  status: Joi.string().required().valid("draft", "active", "inactive", "archived").messages({
...
const productQuerySchema = Joi.object({
  ...
  sortBy: Joi.string().valid("name", "basePrice", "createdAt", "updatedAt").default("createdAt"),
  order: Joi.string().valid("asc", "desc").default("desc"),
  search: Joi.string().optional().trim(),
  category: Joi.string().optional().valid("jersey", "shorts", "jacket", "headgear", "other"),
  sport: Joi.string().optional().hex().length(24),
  status: Joi.string().optional().valid("draft", "active", "inactive", "archived")
});
